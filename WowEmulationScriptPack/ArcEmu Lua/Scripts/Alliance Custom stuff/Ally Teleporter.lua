...
unit:GossipMenuAddItem(0, "|cFF0000FFWelcome to the Ally Teleporter!|r", 0, 0)
unit:GossipMenuAddItem(2, "|cFFCC00CCNetural Cities|r", 1, 0)
unit:GossipMenuAddItem(2, "|cFFCC00CCAlliance Cities|r", 2, 0)
unit:GossipMenuAddItem(2, "|cFFCC00CCCustom Alliance Places|r", 3, 0)
...
if(intid == 2) then
unit:GossipCreateMenu(3000, player, 0)
unit:GossipMenuAddItem(2, "|cFF000000Stormwind City|r", 202, 0)
unit:GossipMenuAddItem(2, "|cFF000000Ironforge City|r", 203, 0)
unit:GossipMenuAddItem(2, "|cFF000000Darnassus Forest|r", 204, 0)
unit:GossipMenuAddItem(2, "|cFF000000Exodar Temple|r", 205, 0)
unit:GossipMenuAddItem(0, "|cFFCC00CC[Back]|r", 999, 0)
unit:GossipSendMenu(player)
end
...
if(intid == 3) then
unit:GossipCreateMenu(3000, player, 0)
unit:GossipMenuAddItem(2, "|cFF000000Alliance Mall|r", 206, 0)
unit:GossipMenuAddItem(2, "|cFF000000Ally Level Road|r", 207, 0)
...
if(intid == 204) then
player:Teleport(1, 8795.8, 969.427, 31.1955)
player:GossipComplete()
end

if(intid == 205) then
player:Teleport(530, -4014.08, -11895.8, 0.99324)
player:GossipComplete()
end

if(intid == 206) then
player:Teleport(723, -8913.64, -135.388, 80.4607)
player:GossipComplete()
end

if(intid == 207) then
player:Teleport(1, 4628.959961, -3823.340088, 943.275024)
player:GossipComplete()
end
...
if(intid == 442) then
player:Teleport(1, 4248.160645, 742.630737, -25.059261)
player:GossipComplete()
end
...
RegisterUnitGossipEvent(999900, 1, "On_Gossip")
RegisterUnitGossipEvent(999900, 2, "Gossip_Submenus")