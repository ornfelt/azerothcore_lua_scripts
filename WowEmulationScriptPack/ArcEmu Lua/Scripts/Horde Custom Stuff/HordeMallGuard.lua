...
pUnit:SendChatMessage(14, 0, "Another pesky Alliance...")
...
RegisterUnitEvent(100001, 1, "Boss_OnCombat")
RegisterUnitEvent(100001, 2, "Boss_OnLeaveCombat")
RegisterUnitEvent(100001, 3, "Boss_OnKilledTarget")
RegisterUnitEvent(100001, 4, "Boss_OnDeath")