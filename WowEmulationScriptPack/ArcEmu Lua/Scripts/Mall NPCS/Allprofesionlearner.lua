...
function Shoper(unit, event, player)
--Menu
...
function ShoperMenu(unit, event, player, id, intid, code)
--Armor Menu Page 1

--Professions NPC START
if(intid == 154) then 
...
unit:SendChatMessage(12,0,"Your Skills Are Set To 450")
unit:GossipMenuAddItem(0, "|cffff0000Back", 210, 0)
unit:GossipSendMenu(player)
end
...
RegisterUnitGossipEvent(900029, 1,"Shoper")
RegisterUnitGossipEvent(900029, 2,"ShoperMenu")