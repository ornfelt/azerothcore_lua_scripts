...
if (intid == 1) then
	pUnit:VendorAddItem(130108,1,1959)
	pUnit:VendorAddItem(130110,1,1959)
	pUnit:VendorAddItem(130106,1,1959)
	pUnit:VendorAddItem(130107,1,1959)
	pUnit:VendorAddItem(130109,1,1959)
...
RegisterUnitGossipEvent(123484, 1, "Vendor_OnGossip")
RegisterUnitGossipEvent(123484, 2, "Vendor_OnSelect")