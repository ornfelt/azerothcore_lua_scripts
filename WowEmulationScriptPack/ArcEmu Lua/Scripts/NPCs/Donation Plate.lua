...
if (intid == 1) then
	pUnit:VendorAddItem(130097,1,1959)
	pUnit:VendorAddItem(130099,1,1959)
	pUnit:VendorAddItem(130095,1,1959)
	pUnit:VendorAddItem(130098,1,1959)
	pUnit:VendorAddItem(130096,1,1959)
...
RegisterUnitGossipEvent(123487, 1, "Vendor_OnGossip")
RegisterUnitGossipEvent(123487, 2, "Vendor_OnSelect")