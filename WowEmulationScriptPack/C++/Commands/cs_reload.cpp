...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "events",                        rbac::RBAC_PERM_COMMAND_EVENTS_RELOAD,                           true,  &HandleReloadEventsCommand,                     "" },
        };
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        HandleReloadEventsCommand(handler, "");
        return true;
    }

    static bool HandleReloadEventsCommand(ChatHandler* handler, char const* /*args*/)
    {
        RBAC_ReloadEventsCommand();
        handler->SendGlobalGMSysMessage("New Periodic Events will reload in one minute.");
        return true;
    }
