...
function makeAllButtons()
	...
	setupButton(CreateFrame("Button", nil, frame),"Damage+",3,3)
	setupButton(CreateFrame("Button", nil, frame),"Loot!",4,4)
end

function setupButton(btn,text,argValue,btnNum)
	btn:SetSize(110, 35)
...
function setButtonTextures(btn)
...
allButtons = {}
frame = CreateFrame("Frame", "FrameTest", UIParent, "UIPanelDialogTemplate")
