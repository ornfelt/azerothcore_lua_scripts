...
--	creature:AddAura(45954)
--	creature:AddAura(270481)
	creature:RegisterEvent(Nostos.Gift, {1200, 15000}, 0)
	creature:RegisterEvent(Nostos.SummonAdd, {20000, 30000}, 0)
	creature:RegisterEvent(Nostos.Corruption, 12000, 0)
	creature:RegisterEvent(Nostos.ShadowBoltVolley, {5000, 70000}, 0)
