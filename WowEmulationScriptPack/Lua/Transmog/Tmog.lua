...
local Locales = {
    ...
    "Remove transmogrifications from all equipped items?",
    "Using this item for transmogrify will bind it to you and make it non-refundable and non-tradeable.\nDo you wish to continue?",
    "Remove transmogrification from %s?",
    "Back..",
    "Remove transmogrification",
    "Transmogrifications removed from equipped items",
    "You have no transmogrified items equipped",
    "%s transmogrification removed",
    "No transmogrification on %s slot",
    "%s transmogrified",
    "Selected items are not suitable",
    "Selected item does not exist",
    "Equipment slot is empty",
    "You don't have enough %ss",
    "Not enough money",
}
...
local function GetSlotName(slot, locale)
    ...
    return locale and SlotNames[slot]
end
