...
struct FLAMEMU_DLL_DECL boss_bjarngrimAI : public ScriptedAI
{
    ...
    //TODO: remove when removal is done by FLAMEMU
...
struct FLAMEMU_DLL_DECL mob_stormforged_lieutenantAI : public ScriptedAI
{
