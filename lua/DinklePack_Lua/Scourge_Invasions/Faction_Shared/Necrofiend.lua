...
RegisterCreatureEvent(Necrofiend.NPC_ID, 1, Necrofiend.OnEnterCombat)
RegisterCreatureEvent(Necrofiend.NPC_ID, 2, Necrofiend.OnLeaveCombat)
RegisterCreatureEvent(Necrofiend.NPC_ID, 4, Necrofiend.OnDied)
