/*
SPP Start Equipment Modules
Created for Gwenpool's Cata Project
...
public:
    ...
    {
        if (sConfigMgr->GetBoolDefault("Spp.Start.Equipment", true))
        {
            if (!firstLogin)
                return;
...
class SPP_start_equipment_announce : public PlayerScript
{
public:
    SPP_start_equipment_announce() : PlayerScript("SPP_start_equipment_announce") { }
...
{
    new start_equipment();
    new SPP_start_equipment_announce();
}
